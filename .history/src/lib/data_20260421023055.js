...
export const fallbackProducts = [
  {
    ...
    images: ['/products/P1.0.png','/products/P1.1.png','/products/P1.2.png','/products/P1.3.png'],
    fileLink: "https://drive.google.com/drive/folders/1seykNaoyrelcJ-zDTbABJVcuUO1ncNHd?usp=drive_link",
    description: "Give your food delivery project a modern, polished look with 3 premium mobile screens crafted to impress users and boost engagement. Clean UI, smart UX, and ready-to-use designs delivered instantly.",
  },
  {
    id: 2,
    ...
    type: "Product",
    price: 5,
    image: '/products/P2.0.png',
    images: ['/products/P2.0.png','/products/P2.1.png','/products/P2.2.png','/products/P2.3.png'],
    fileLink: "https://drive.google.com/drive/folders/1uXzhaatZPLe3kUzPfJZQqQRfuilx0OvI?usp=drive_link",
    description: "Upgrade your healthcare app with 3 elegant booking screens designed for smooth appointments and better user trust. Professional, user-friendly, and ready to elevate your product instantly.",
  },
];
