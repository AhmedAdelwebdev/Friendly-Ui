              ...
              <>
                ...
                {step === 2 && (
                  <div className="animate-in fade-in slide-in-from-right-10 duration-500">
                    ...
                    {isBackendDown ? (
                      <div className="bg-red-500/20 border-2 border-red-100 rounded-2xl p-6 mb-6 text-center animate-in zoom-in-95">
                        <div className="size-12 bg-red-100 text-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                          <X size={24} />
                        </div>
