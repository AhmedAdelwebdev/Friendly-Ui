...
` + (!isAttempt && `• Order ID: <code>${orderId}</code>`);
          ...
          <div className="flex items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-2">
              <button onClick={() => setLang(l => l === 'EN' ? 'AR' : 'EN')} 
                className="w-10 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-full transition-all border border-black/5 text-base sm:text-xs text-gray-700 flex items-center gap-1.5 font-bold uppercase tracking-wider"
              >
