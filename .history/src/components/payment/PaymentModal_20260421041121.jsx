                  ...
                  <div className="animate-in fade-in slide-in-from-right-10 duration-500">
                    ...
                    {isBackendDown ? (
                      <div className="p-6 mb-6 text-center animate-in zoom-in-95">
                        ...
                        <Link href="https://t.me/Friendly_Ui" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full bg-[#0088cc] text-white py-4 rounded-xl text-sm font-bold shadow-lg shadow-[#0088cc]/20 hover:scale-[1.02] transition-all" >
                          <MessageSquare size={18} />
