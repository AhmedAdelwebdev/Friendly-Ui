    ...
    <section className={`py-12 md:py-16 ${type === 'Product' ? 'bg-gray-100/30' : ''}`}>
      <div className=" mx-auto px-4">
        <div className="flex items-end justify-between mb-8 gap-4">
          ...
          <Link href={type === 'Product' ? '/designs' : '/designs?type=designs'} className="group flex items-center gap-1.5 text-primary  text-sm hover:gap-3 transition-all whitespace-nowrap">
            View All
          </Link>
        </div>
