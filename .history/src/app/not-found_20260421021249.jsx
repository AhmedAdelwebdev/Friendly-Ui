  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
      ...
      <div className="relative mb-8">
        <div className="text-[8rem] font-heading text-primary/50 select-none leading-none ">404</div>
      </div>

      {/* Content */}
      <h1 className="text-2xl md:text-4xl font-heading text-gray-900 mb-4">
