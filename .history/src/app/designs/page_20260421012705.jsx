  ...
  return (
    <div className="py-10 md:py-16">
      ...
      <div className="w-full">
        ...
        {/* Search + Filters */}
        <div className={`relative w-[90vw] sm:max-w-[80vw] md:max-w-3xl mx-auto p-1 rounded-[27px] sm:rounded-full shadow-sm mb-10 bg-primary`}>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            {/* Types (Desktop) */}
            <div className="absolute right-1 h-11 hidden sm:flex bg-body border-l-2 border-primary/70 p-1 pl-1.5 rounded-full w-fit">
              {types.map((type) => (
                <button
                  key={type}
