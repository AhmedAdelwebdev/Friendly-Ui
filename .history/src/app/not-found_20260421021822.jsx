  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
      ...
      <div className="relative mb-8">
        <div className="text-[8rem] font-heading text-primary/70 select-none leading-none animate-pulse duration-[2000ms]">404</div>
      </div>

      {/* Content */}
      <h1 className="text-2xl font-heading text-gray-300 mb-4">
