          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="flex-1 text-center md:text-left space-y-5">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-4">
                <Link href="https://t.me/Friendly_Ui" target="_blank" rel="noopener noreferrer" className="bg-primary text-white px-8 py-3 rounded-2xl  text-base hover:opacity-90 transition-all flex items-center gap-2 shadow-lg shadow-primary/20">
