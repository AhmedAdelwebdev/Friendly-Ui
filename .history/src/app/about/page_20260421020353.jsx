...
import { Mail, MessageCircle, ArrowUpRight, Briefcase, Award, Zap, Palette } from 'lucide-react';
...
export default function AboutPage() {
  const skills = [
    ...
    { name: 'Mobile App Design', level: '100%' },
  ];
        ...
        <div className=" mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="relative w-full max-w-sm">
              <div className="absolute inset-0 m-auto size-80 bg-primary dark:bg-primary/50 blur-3xl rounded-full"></div>
            ...
            <div className="flex-1 text-center md:text-left space-y-5">
              <div className="inline-block px-4 py-1.5 bg-primary/10 text-primary rounded-xl text-sm shadow-sm">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-4">
                <Link href="https://t.me/Friendly_Ui" target="_blank" rel="noopener noreferrer" className="bg-primary text-white px-8 py-3 rounded-2xl  text-base hover:opacity-90 transition-all flex items-center gap-2 shadow-lg shadow-[#0088cc]/20">
                  <MessageCircle size={18} /> Telegram Me
                </Link>
                <Link href="/desgins" className="border border-primary/20 text-primary px-8 py-3 rounded-2xl  text-base hover:bg-primary/5 transition-all flex items-center gap-2">
                  <Palette size={18} /> Contact Email
                </Link>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                {skills.map((skill, index) => (
                  <div key={index} className="space-y-2">
                    ...
                    <div className="w-full h-4 bg-gray-100 rounded-full overflow-hidden border border-gray-100 p-0.5">
                      <div
