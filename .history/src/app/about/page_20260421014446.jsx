        ...
        <div className=" mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="relative w-full max-w-sm">
              <div className="absolute inset-0 m-auto size-96 bg-primary/20 blur-3xl rounded-full"></div>
              <div className="aspect-square rotate-2 group hover:rotate-0 transition-transform duration-500 border-4 border-white">
