...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen pb-16">
      {/* Hero Section */}
      <section className="relative pt-12 md:pt-20 pb-16 md:pb-24 overflow-hidden reveal animate-up">
        <div className="mx-auto px-4 sm:px-12 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            {/* Content */}
            <div className="flex-1 text-center md:text-left space-y-5 animate-fade-in-left">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-4 animate-fade-in-up delay-200">
      ...
      {/* Stats Section */}
      <section className="bg-gray-100/50 py-12 md:py-16 animate-fade-in-up reveal animate-up">
...
function StatCard({ icon, title, desc }) {
  return (
    <div className="text-center md:text-left space-y-3 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm animate-fade-in-up">
