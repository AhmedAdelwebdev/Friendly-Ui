      ...
      <div className=" mx-auto px-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-10">
          ...
          <div className="flex-1 text-center sm:text-left space-y-4">
            <div className="text-2xl md:text-3xl font-heading text-gray-900 leading-tight reveal animate-up" suppressHydrationWarning>
              <h2 className="text-primary text-5xl">Friendly Ui</h2>
              <h2 className="mt-3">Where Ideas Meet Design</h2>
            </div>
            <p className="text-base md:text-lg text-gray-500 font-medium leading-relaxed max-w-xl mx-auto lg:mx-0 reveal animate-up delay-100" suppressHydrationWarning>
              Designing clean interfaces and building smart solutions. Explore my latest work, premium products, and creative experiments.
            </p>

            <div className="flex items-center justify-center sm:justify-start gap-3 pt-4 reveal animate-up delay-200" suppressHydrationWarning>
