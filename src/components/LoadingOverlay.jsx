...
export const LoadingOverlay = ({ message = 'Loading', type = 'default' }) => {
  return (
    <div className="fixed inset-0 z-[1000] bg-white/90 dark:bg-black/90 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-500">
      {/* Logo in center */}
